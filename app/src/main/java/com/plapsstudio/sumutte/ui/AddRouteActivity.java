...
import com.plapsstudio.sumutte.model.Location;
...
public class AddRouteActivity extends BaseActivity implements GoogleMap.OnMapClickListener, GoogleApiClient.ConnectionCallbacks,
    ...
    public void bntAddMap() {
        startActivityForResult(new Intent(this, com.plapsstudio.sumutte.ui.AddMapActivity.class), ADD_MAP_KEY);
    }
    @OnClick(R.id.mps)
    public void mps() {
        startActivityForResult(new Intent(this, com.plapsstudio.sumutte.ui.AddMapActivity.class), ADD_MAP_KEY);
    ...
    public void getRoute() {
        if (!TextUtils.isEmpty(etFrom.getText())) {
            ...
            startActivity(new Intent(this, com.plapsstudio.sumutte.ui.ViewRouteActivity.class).putExtras(data));
        } else {
