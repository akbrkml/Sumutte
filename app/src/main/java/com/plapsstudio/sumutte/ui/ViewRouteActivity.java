...
import com.plapsstudio.sumutte.Constant;
import com.plapsstudio.sumutte.R;
import com.plapsstudio.sumutte.helper.Utils;
import com.plapsstudio.sumutte.json.Legs;
import com.plapsstudio.sumutte.json.Steps;
...
public class ViewRouteActivity extends FragmentActivity {
    ...
    private com.plapsstudio.sumutte.json.Response response;
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET,
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject jsonObject) {
                        ...
                        response = new Gson().fromJson(jsonObject.toString(), com.plapsstudio.sumutte.json.Response.class);
